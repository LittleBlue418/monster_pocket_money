...
from monster_pocket_money.resources.jobinstances import (
    JobInstance, JobInstancesCollection, ApproveJobInstance)
...
api.add_resource(ApproveJobInstance, '/api/jobinstances/<jobinstance_id>/approve')
